        ...
        <div className="_home_001">
            <div className="_home_002">
                ...
                <div className="_home_004 _home_020">
                        ...
                        <div className="_home_014">
                            <div className="_home_015">
                                ...
                                <div className="_order_110">
                                    <div
                                        style={{ padding: "5px 2px", fontWeight: 500, textTransform: "uppercase" }}
                                        onClick={() => {
                                            setOpen(true);
                                        }}
                                    >
                                ...
                                <div className="_home_017">
                                    ...
                                    {sort_status.map((status, index) => (
                                        <div
                                            key={index}
                                            className={`_home_019 ${
                                                selectedSort === index ? "_home_sortSelected" : "_home_sortNotSelected"
                                            }`}
                    ...
                    {products.length > 0 && products.map((product) => <Homechild key={product.id} product={product} loader={loader} />)}
            ...
            <div className="_home_sort">
                <SwipeableDrawer anchor="bottom" open={open} onClose={toggleDrawer} onOpen={toggleDrawer} sx={{ zIndex: 100 }}>
                    <FilterHome
                        setOpen={setOpen}
                        type="mobile"
                        products={products}
