        ...
        <div>
            ...
            <div>
                {BankRadio.map((value, index) =>
                    <label key={value.value + index} htmlFor={`bank_00${value.value}_${id}`}
                        className="_payment_017">
                        <div className="_payment_003">
                            <input
                                ...
                                onChange={() => { handleRadioBank(index) }}
                            />
                        </div>
                        <div className="_payment_013">
                            <div>
                                <div className="_payment_005" style={{ fontSize: '13px' }}>{value.bankName}</div>
                            </div>
                        </div>
                    </label>
                )}
                ...
                <FormControl sx={{ m: 1, minWidth: 120, margin: 0 }} size="small">
                    ...
                    >
                        ...
                        {BankOptions.map((value, index) =>
                            <MenuItem key={value.value + index} value={value.value}>{value.bankName}</MenuItem>
                        )}
                    </Select>
                </FormControl>
            </div>
            <div className="_payment_006">
                <button disabled={radioBank === -1 && selectedBank === ""} className="_check_025" style={{
