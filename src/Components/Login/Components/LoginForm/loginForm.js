    ...
    return (
        <div>
            <form onSubmit={(event) => {
                ...
                {loginType !== 'Login'
                    &&
                    <ConfirmPassComponent formData={formData} handleInput={handleInput} />
                }
            ...
            {id === 1
                ...
                <>
                    <div className='_sign_014'>
                        {loginType === 'Login'
                            ?
                            <div className='_sign_015' onClick={() => { setLoginType('Sign Up'); handleInputClear(setHelperText, setFormData) }}>
                                New to Flipkart? Create an account
                            </div>
                            :
                            <div className='_sign_015' onClick={() => {
