                ...
                <div className="_order_016">
                    ...
                    <div className="_order_018">
                        ...
                        <div className="_order_014 _order_015 w-3-4">
                            {selectedOrder.order_details.address.address}, {selectedOrder.order_details.address.locality},{" "}
                            {selectedOrder.order_details.address.area} - {selectedOrder.order_details.address.pincode},{" "}
                            {selectedOrder.order_details.address.state}
                        </div>
                        ...
                        {selectedOrder.order_details.data && <PaymentDetails order={selectedOrder.order_details} />}
                    </div>
                </div>
            </div>
