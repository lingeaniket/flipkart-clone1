        ...
        <div className="_manageAdd_005">
            {edit
                ...
                <div className="_manageAdd_006">
                    ...
                    <div>
                        <span className="_check_021" style={{ margin: 0 }}>{address.res_type}</span>
                    </div>
                    <p style={{
                    ...
                    <span>
                        {address.address}, {address.locality}, {`${address.landmark && `${address.landmark},`}`} {address.area}, {address.state} -
                        <span style={{ fontWeight: 500 }}> {address.pincode}</span>
                    </span>
                </div>
            }
        </div>
