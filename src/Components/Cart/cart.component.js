            ...
            <div className='cartF2'>
              <div className='cartF2-1'>
                ...
                <div className='cartF2Flex'>
                  ...
                  {/* <div className='cartF2Flex1 cartF2text'>{ < 50 ? '$ 0.5' : 'Free'}</div> */}
                </div>
              ...
              <div className='cartF2-2'>
                <div className='cartF2Flex'>
                  ...
                  {/* <div className='cartF2Flex1 cartF2text2'>$ {totalPrice < 50 ? Math.round((totalPrice + 0.5) * 100) / 100 : Math.round((totalPrice) * 100) / 100}</div> */}
                </div>
              </div>
