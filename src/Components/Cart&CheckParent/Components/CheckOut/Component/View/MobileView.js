        ...
        <Paper className="_check_068">
            ...
            <Box sx={{ width: "100%", display: "flex", justifyContent: "center" }}>
                <div style={{ width: "90%" }}>
                    ...
                    {selectedStep === 1 && <LoginComponent setSelectedStep={setSelectedStep} id={id} />}
                    {selectedStep === 2 && (
                        <AddressComponent1
                            id={id}
                    ...
                    {selectedStep === 3 && (
                        <OrderSummaryComponent orderProducts={orderProducts} item_id={item_id} id={id} setSelectedStep={setSelectedStep} />
                    )}
                    {selectedStep === 4 && (
                        <PaymentComponent
                            id={id}
            ...
            <>
                ...
                >
                    <Button color="inherit" disabled={selectedStep - 1 === 0} onClick={handleBack} sx={{ mr: 1 }}>
